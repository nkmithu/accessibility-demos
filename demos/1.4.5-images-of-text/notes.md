# Teaching notes — 1.4.5 Images of Text (Level AA)
...
No automated rule exists for this criterion at all. Recognising that an image contains text requires OCR and human judgement about whether it is essential.
...
- [1.4.5 in the WCAG 2.2 Recommendation](https://www.w3.org/TR/WCAG22/#images-of-text)
