# Teaching notes — 3.1.3 Unusual Words (Level AAA)
...
No automated rule exists for this criterion at all. Identifying which words are unusual for the audience requires human reading.
...
- [3.1.5 Reading Level (AAA)](../3.1.5-reading-level/index.html)

## Specification

- [Understanding 3.1.3 Unusual Words](https://www.w3.org/WAI/WCAG22/Understanding/unusual-words.html)
- [3.1.3 in the WCAG 2.2 Recommendation](https://www.w3.org/TR/WCAG22/#unusual-words)
