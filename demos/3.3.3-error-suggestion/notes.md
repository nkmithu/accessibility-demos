# Teaching notes — 3.3.3 Error Suggestion (Level AA)
...
No automated rule exists for this criterion at all. Requires reading each error message and judging whether it is actionable.
...
- [3.3.3 in the WCAG 2.2 Recommendation](https://www.w3.org/TR/WCAG22/#error-suggestion)
