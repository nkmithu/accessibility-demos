# Teaching notes — 2.2.4 Interruptions (Level AAA)
...
No automated rule exists for this criterion at all. Requires exercising the interface over time and checking preferences.
...
- [Understanding 2.2.4 Interruptions](https://www.w3.org/WAI/WCAG22/Understanding/interruptions.html)
- [2.2.4 in the WCAG 2.2 Recommendation](https://www.w3.org/TR/WCAG22/#interruptions)
