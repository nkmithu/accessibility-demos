# Teaching notes — 1.2.9 Audio-only (Live) (Level AAA)
...
No automated rule exists for this criterion at all. Requires observing the live event.
...
- [Understanding 1.2.9 Audio-only (Live)](https://www.w3.org/WAI/WCAG22/Understanding/audio-only-live.html)
- [1.2.9 in the WCAG 2.2 Recommendation](https://www.w3.org/TR/WCAG22/#audio-only-live)
