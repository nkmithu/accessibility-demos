# Teaching notes — 2.2.5 Re-authenticating (Level AAA)
...
No automated rule exists for this criterion at all. Requires an end-to-end session-expiry test.
...
- [Understanding 2.2.5 Re-authenticating](https://www.w3.org/WAI/WCAG22/Understanding/re-authenticating.html)
- [2.2.5 in the WCAG 2.2 Recommendation](https://www.w3.org/TR/WCAG22/#re-authenticating)
