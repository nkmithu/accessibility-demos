# Teaching notes — 2.2.3 No Timing (Level AAA)
...
No automated rule exists for this criterion at all. Requires reviewing the whole flow for time dependencies.
...
- [Understanding 2.2.3 No Timing](https://www.w3.org/WAI/WCAG22/Understanding/no-timing.html)
- [2.2.3 in the WCAG 2.2 Recommendation](https://www.w3.org/TR/WCAG22/#no-timing)
